...
app.post('/register', async (req, res) => {
  ...
  let browser;
  try {
    // Pokrećemo Puppeteer iz node_modules
    ...
    if (!formReady) throw new Error("Input 'first_name' nije pronađen ni nakon 40 sekundi.");
    ...
    try {
      ...
      console.error('⚠️ Nije uspelo snimanje za debug:', dumpErr);
    }
